...
async function init() {
    console.log("Hello there!!! Answer a couple of questions below to see your GitHub Resume. Please be sure to completely file out your github for best results. Use My id for an example:locdandcoded")
    try {
